...
public class RedLeft extends PIDAutonomous {
    ...
    public void run() throws InterruptedException{
        ...
        robot.driveToInch(.2, 29);//Drive off balancing stone
        gyroscope.rotate(0);
        sleep(200);
        ...
        gyroscope.drive(0.6, 16);//Drive to glyph pit
        gyroscope.drive(0.6, 17);// Drive into glyph pit
        //0.2: 0.75
