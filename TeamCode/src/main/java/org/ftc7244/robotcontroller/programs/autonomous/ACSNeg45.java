...
public class ACSNeg45 extends ControlSystemAutonomous {
    ...
    private void turn(double target){
        double offset = gyroProvider.getZ(), basePower=0.4, slowRange=45, stopOffset=7, polarity = -target<0?-1:1, stopRange = 5;
